...
/** KeycloakRestClient implements REST API requests for user management in Keycloak. */
@Path("/auth")
@RegisterRestClient(configKey = "keycloak-api")
public interface KeycloakRestClient {

    /**
    * Request oidc access token for the realm administrator of Keycloak realm.
    *
    ...
    * implemented for a usecase and is not necessary anymore. But it may be necessary later.
    * ************************************************************ Get a created Keycloak user by
    * email address.
    *
    * @param realm Realm name of Keycloak realm
    * @param auth Bearer token for OIDC authorization
